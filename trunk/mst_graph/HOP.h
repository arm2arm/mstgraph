...
enum eCOLORS {
    BLACK_WHITE, BLUE_WHITE, GRN_RED_BLU_WHT, RED_TEMP, BGRY, STD_GAMMA, PRISM, RED_PURPLE, GREEN_WHITE_LIN, GREEN_WHITE_EXP, RAINBOW = 13, HAZE = 16, MAC_STYLE = 25, RAINBOW_2 = 49};
